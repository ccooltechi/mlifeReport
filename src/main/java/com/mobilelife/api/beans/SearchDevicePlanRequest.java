...
public class SearchDevicePlanRequest {
    ...
    @XmlElement
    private DevicePlan search_criteria;
	/**
	 ...
	 */
	public DevicePlan getSearch_criteria() {
		return search_criteria;
	}
	/**
	 * @param search_criteria the search_criteria to set
	 */
	public void setSearch_criteria(DevicePlan search_criteria) {
