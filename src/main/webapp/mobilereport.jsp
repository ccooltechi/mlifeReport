...
<%@page import="com.mobilelife.api.beans.SearchRequest"%>
<%@page import="com.mobilelife.persistance.entities.SearchDetails"%>
...
<body>
	...
	<div class="am-pagetitle">
		<h2 class="am-title">Searches Report</h2>
	</div>
	<!-- am-pagetitle -->
...
<%
	...
	HashMap<String, List<SearchDetails>> responseHM = (HashMap) sessionsa.getAttribute("reponseHM");
...
%>
									<div class="col-xs-12">
										<div class="form-group">
											<label class="form-check-label"><%=mentry.getKey()%> searched counts are <%=count%></label>
											<button type="button"  onclick="javascript:showsearches('<%=mentry.getKey()%>');" style="float:right;font-size:12px;font-weight:bold;">Show Search</button>
...
%>    	   
				<div>
					<div class="form-check-label"><%=searchDetails.getAppid()%></div>
